/**
 * Obtained by s/python/mojo/ on the scanner for Python at
 * https://github.com/tree-sitter/tree-sitter-python/blob/409b5d671eb0ea4972eeacaaca24bbec1acf79b1/src/scanner.c
 */
